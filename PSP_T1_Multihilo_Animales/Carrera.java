...
public class Carrera extends javax.swing.JFrame {
    ...
    //evento de clicar el boton
    private void botonComenzarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonComenzarMouseClicked
        //Creamos los hilos de cada animal, donde le pasaremos la ventana
        //el nombre del animal y el tiempo.
   ...
   //clase para setear el mensaje que saldra
public void setMensaje(String animal,int i){
    //Se le pasa un string que sera el animal, y un int con la posicion de la carrera
        if(animal.equals("Tortuga")){
            //añade al List los elementos
